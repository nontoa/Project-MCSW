...
public class Usuario {
    ...
    public String index() {
        return """
                              ...
                              <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">Mi cuenta</h2>
                              </div>
                              ...
                              <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">Gestión de transacciones</h2>
                              <p>Señor Usuario, recuerde que en esta sección puede ver su saldo total, el detalle de los movimientos,
                              solicitar sobregiros y ver las transferencias entre su cuentas y cuentas de otros bancos. 
